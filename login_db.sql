...
--
-- Host: localhost:3306
-- Generation Time: Dec 09, 2025 at 12:58 AM
...
INSERT INTO `pedidos` (`id`, `user_id`, `fecha_pedido`, `total`, `estado`) VALUES
(31, 2, '2025-12-06 21:58:18', '40.00', 'completado'),
(32, 2, '2025-12-06 22:02:13', '290.00', 'completado'),
(33, 2, '2025-12-06 22:15:24', '120.00', 'completado'),
(34, 2, '2025-12-08 20:55:36', '485.00', 'completado');
...
(13, 'Aceite para carro Inca', 'Lubricante sintético de alto rendimiento, ideal para motores modernos.', '20.00', 40, '../images/productos/aceite para carro inca.jpg', 0, 2),
(14, 'Filtros MHW', 'Filtros de aire de alta eficiencia, protege tu motor del polvo.', '15.00', 21, '../images/productos/filtros-MHW.png', 0, 5),
(15, 'Base Con Bombin Para Filtros', 'Base de metal con bombín manual para purgar el sistema de combustible.', '60.00', 10, '../images/productos/base con bombin para filtros.jpg', 0, 1),
(16, 'Filtros Combustible 3196', 'Filtro estándar de combustible, recomendado para diésel y gasolina.', '10.00', 0, '../images/productos/Filtros Combustible 3196.png', 0, 0),
(17, 'Filtros De Aceite', 'Filtro de aceite de larga duración para mantener limpio el motor.', '30.00', 28, '../images/productos/filtro-de-aceite-30dolares.png', 0, 5),
(18, 'Amortiguador Delantero Chevrolet Spark', 'Amortiguador de suspensión para eje delantero derecho.', '40.00', 20, '../images/productos/Amortiguador Delantero Chevrolet Spark 96424026 Derecho (rh).webp', 0, 7);
...
(1, 'administrador', 'Kevyn', 'kevyncamacaro1@gmail.com', '$2y$10$FpW2gVY3kyjB5QX5e2MZfu3wUql0MKm6/InPnExjVtMjLTSjwE6Rq'),
